    ...
    export class Jugador extends Phaser.Sprite{
        ...
        constructor(game:Phaser.Game, x:number,y:number){
            ...
            20,true);
             ...
             (<Phaser.Physics.P2.Body>this.body).setRectangle(this.width/1.5,this.height,0,0);
             (<Phaser.Physics.P2.Body>this.body).fixedRotation=true;
             (<Phaser.Physics.P2.Body>this.body).mass=10;
            
            (<Phaser.Physics.P2.Body>this.body).addRectangle(this.width/1.7,this.height/10,0,this.height/1.9);             
            ...
            this.restriccionGlobo1=this.game.physics.p2.createLockConstraint(this.body,this.globo1.body,[-this.width/6,this.height/1.4],0);
            this.restriccionGlobo2=this.game.physics.p2.createLockConstraint(this.body,this.globo2.body,[this.width/6,this.height/1.4],0);
