...
module Elioway.BallonFight {
    ...
    export class Level1 extends Phaser.State {
        ...
        create() {
            ...
            this.enemigos = new Array<Enemigo>();
            this.enemigos.push(new Enemigo(this.game, 800 / 1.15, 480 / 3.3, 'Rosa', this.jugador));
            this.enemigos.push(new Enemigo(this.game, 800 / 6, 480 / 6, 'Verde', this.jugador));
            this.enemigos.push(new Enemigo(this.game, 800 / 2, 480 / 2.30, 'Amarillo', this.jugador));
        ...
        colisionEntreOceanoyOtro(body1, body2) {
            ...
            if ((<Phaser.Physics.P2.Body>body1).sprite.name == 'CabezaJugador') {
            ...
            if ((<Phaser.Physics.P2.Body>body1).sprite.name == 'CabezaEnemigo') {
                new Salipicadura(this.game, (<Phaser.Physics.P2.Body>body1).x, (<Phaser.Physics.P2.Body>body1).y - this.jugador.height);
            }
