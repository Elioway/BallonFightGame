module Elioway.BallonFight {
    ...
    export class GestorGrupos {
        ...
        grupoEnemigo: Phaser.Group;
        grupoJugador: Phaser.Group;
        grupoParacaidas: Phaser.Group;
        ...
        grupoColisionEnemigo: Phaser.Physics.P2.CollisionGroup;
        grupoColisionJugador: Phaser.Physics.P2.CollisionGroup;
        grupoColisionGloboEnemigo: Phaser.Physics.P2.CollisionGroup;
        ...
        configurarColisionamiento(sprite: Phaser.Sprite, tipo: String): void {
            if (tipo == "Terreno") {
                ...
                (<Phaser.Physics.P2.Body>sprite.body).collides([this.grupoColisionElectroEstrella, this.grupoColisionJugador, this.grupoColisionGloboJugador, this.grupoColisionEnemigo]);
                ...
                (<Phaser.Physics.P2.Body>sprite.body).collides([this.grupoColisionTerreno, this.grupoColisionElectroEstrella, this.grupoColisionMandibulaPez, this.grupoColisionEnemigo, this.grupoColisionGloboEnemigo]);

            } else if (tipo == "GloboJugador") {

                (<Phaser.Physics.P2.Body>sprite.body).collides([this.grupoColisionTerreno, this.grupoColisionEnemigo, this.grupoColisionGloboEnemigo]);

            } else if (tipo == 'GloboEnemigo') {

                (<Phaser.Physics.P2.Body>sprite.body).collides([this.grupoColisionTerreno, this.grupoColisionGloboJugador, this.grupoColisionJugador]);
                ...
                (<Phaser.Physics.P2.Body>sprite.body).collides([this.grupoColisionTerreno, this.grupoColisionJugador, this.grupoColisionGloboJugador]);
